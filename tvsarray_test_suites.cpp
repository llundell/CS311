// tvsarray_test_suites.cpp
// Glenn G. Chappell
// 24 Oct 2018
//
// For CS 311 Fall 2018
// Tests for class template TVSArray: test suites
// For Project 5, Exercise A
// Uses the "Catch" unit-testing framework, version 2
// Requires tvsarray_test_main.cpp, catch.hpp, tvsarray.h
               ...
               const Counter & b)
{
    ...
    (void)b;  // Avoid unused-parameter warning
    return false;
}
           ...
           "[types]" )
{
    ...
    SECTION( "Member function erase - return type" )
    {
        ...
        (void)r;  // Avoid unused-variable warning
        INFO( "TVSArray<int> erase returns (int *) by value" );
        ...
        (void)r;  // Avoid unused-variable warning
        INFO( "TVSArray<string> erase returns (string *) by value" );
           ...
           "[exceptions]" )
{
    ...
    SECTION( "noexcept - move ctor" )
    {
        ...
        REQUIRE( noexcept(TVSArray<Counter>(move(tc1))) );
    }
    ...
    SECTION( "NOT noexcept - copy ctor" )
    {
        ...
        REQUIRE_FALSE( noexcept(TVSArray<Counter>(tc1)) );
    }

    SECTION( "NOT noexcept - ctor from size" )
    {
        INFO( "Ctor from size must NOT be noexcept" );
        REQUIRE_FALSE( noexcept(TVSArray<Counter>(100)) );
    }
...
TEST_CASE( "TVSArray insert & erase",
           "[member funcs]" )
{
...
TEST_CASE( "TVSArray push_back & pop_back",
           "[member funcs]" )
{
